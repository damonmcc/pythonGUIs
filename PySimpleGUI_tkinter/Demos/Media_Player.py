...
def MediaPlayerGUI():
    ...
    ImageButton = lambda image_filename, key: sg.Button('', button_color=(background, background),
                                                        image_filename=image_filename, image_size=(50, 50),
                                                        image_subsample=2, border_width=0, key=key)
